...
<!-- simit:badges:start -->
![CI](https://img.shields.io/badge/CI-managed+extra-2088ff) [![Nix](https://img.shields.io/badge/Nix-managed-5277c3)](flake.nix) [![docs](https://img.shields.io/badge/docs-enabled-6f42c1)](docs)
<!-- simit:badges:end -->
